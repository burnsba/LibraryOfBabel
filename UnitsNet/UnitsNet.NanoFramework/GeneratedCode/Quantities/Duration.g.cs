...
namespace UnitsNet
{
    ...
    public struct  Duration
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromGigayearsAgo(double gigayearsago) => new Duration(gigayearsago, DurationUnit.GigayearsAgo);
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromKiloyearsAgo(double kiloyearsago) => new Duration(kiloyearsago, DurationUnit.KiloyearsAgo);

        /// <summary>
        ///     Creates a <see cref="Duration"/> from <see cref="DurationUnit.MegayearsAgo"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromMegayearsAgo(double megayearsago) => new Duration(megayearsago, DurationUnit.MegayearsAgo);
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromYearsAgo(double yearsago) => new Duration(yearsago, DurationUnit.YearsAgo);
            ...
            return new Duration(value, fromUnit);
                ...
                private double GetValueInBaseUnit()
                {
                    return Unit switch
                    {
                        ...
                        DurationUnit.GigayearsAgo => (_value * 365 * 24 * 3600) * 1e9d,
                        DurationUnit.Hour => _value * 3600,
                        DurationUnit.JulianYear => _value * 365.25 * 24 * 3600,
                        DurationUnit.KiloyearsAgo => (_value * 365 * 24 * 3600) * 1e3d,
                        DurationUnit.MegayearsAgo => (_value * 365 * 24 * 3600) * 1e6d,
                        ...
                        DurationUnit.YearsAgo => _value * 365 * 24 * 3600,
                ...
                private double GetValueAs(DurationUnit unit)
                {
                    ...
                    return unit switch
                    {
                        ...
                        DurationUnit.GigayearsAgo => (baseUnitValue / (365 * 24 * 3600)) / 1e9d,
                        DurationUnit.Hour => baseUnitValue / 3600,
                        DurationUnit.JulianYear => baseUnitValue / (365.25 * 24 * 3600),
                        DurationUnit.KiloyearsAgo => (baseUnitValue / (365 * 24 * 3600)) / 1e3d,
                        DurationUnit.MegayearsAgo => (baseUnitValue / (365 * 24 * 3600)) / 1e6d,
                        ...
                        DurationUnit.YearsAgo => baseUnitValue / (365 * 24 * 3600),
