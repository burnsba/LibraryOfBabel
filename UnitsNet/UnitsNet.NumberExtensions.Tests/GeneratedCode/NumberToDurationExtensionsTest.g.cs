...
namespace UnitsNet.Tests
{
    public class NumberToDurationExtensionsTests
    {
        ...
        [Fact]
        public void NumberToGigayearsAgoTest() =>
            Assert.Equal(Duration.FromGigayearsAgo(2), 2.GigayearsAgo());
        ...
        [Fact]
        public void NumberToKiloyearsAgoTest() =>
            Assert.Equal(Duration.FromKiloyearsAgo(2), 2.KiloyearsAgo());

        [Fact]
        public void NumberToMegayearsAgoTest() =>
            Assert.Equal(Duration.FromMegayearsAgo(2), 2.MegayearsAgo());
        ...
        [Fact]
        public void NumberToYearsAgoTest() =>
            Assert.Equal(Duration.FromYearsAgo(2), 2.YearsAgo());
