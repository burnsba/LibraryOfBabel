...
namespace UnitsNet.NumberExtensions.NumberToDuration
{
    ...
    public static class NumberToDurationExtensions
    {
        ...
        /// <inheritdoc cref="Duration.FromGigayearsAgo(UnitsNet.QuantityValue)" />
        public static Duration GigayearsAgo<T>(this T value)
            where T : notnull
#if NET7_0_OR_GREATER
            , INumber<T>
#endif
            => Duration.FromGigayearsAgo(Convert.ToDouble(value));
        ...
        /// <inheritdoc cref="Duration.FromKiloyearsAgo(UnitsNet.QuantityValue)" />
        public static Duration KiloyearsAgo<T>(this T value)
            where T : notnull
#if NET7_0_OR_GREATER
            , INumber<T>
#endif
            => Duration.FromKiloyearsAgo(Convert.ToDouble(value));

        /// <inheritdoc cref="Duration.FromMegayearsAgo(UnitsNet.QuantityValue)" />
        public static Duration MegayearsAgo<T>(this T value)
            where T : notnull
#if NET7_0_OR_GREATER
            , INumber<T>
#endif
            => Duration.FromMegayearsAgo(Convert.ToDouble(value));
        ...
        /// <inheritdoc cref="Duration.FromYearsAgo(UnitsNet.QuantityValue)" />
        public static Duration YearsAgo<T>(this T value)
            where T : notnull
#if NET7_0_OR_GREATER
            , INumber<T>
#endif
            => Duration.FromYearsAgo(Convert.ToDouble(value));
