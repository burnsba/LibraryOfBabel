...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Duration()
        {
            ...
            Info = new QuantityInfo<DurationUnit>("Duration",
                new UnitInfo<DurationUnit>[]
                {
                    ...
                    new UnitInfo<DurationUnit>(DurationUnit.GigayearsAgo, "GigayearsAgo", BaseUnits.Undefined, "Duration"),
                    ...
                    new UnitInfo<DurationUnit>(DurationUnit.KiloyearsAgo, "KiloyearsAgo", BaseUnits.Undefined, "Duration"),
                    new UnitInfo<DurationUnit>(DurationUnit.MegayearsAgo, "MegayearsAgo", BaseUnits.Undefined, "Duration"),
                    ...
                    new UnitInfo<DurationUnit>(DurationUnit.YearsAgo, "YearsAgo", new BaseUnits(time: DurationUnit.YearsAgo), "Duration"),
                },
        ...
        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="DurationUnit.GigayearsAgo"/>
        /// </summary>
        public double GigayearsAgo => As(DurationUnit.GigayearsAgo);
        ...
        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="DurationUnit.KiloyearsAgo"/>
        /// </summary>
        public double KiloyearsAgo => As(DurationUnit.KiloyearsAgo);

        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="DurationUnit.MegayearsAgo"/>
        /// </summary>
        public double MegayearsAgo => As(DurationUnit.MegayearsAgo);
        ...
        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="DurationUnit.YearsAgo"/>
        /// </summary>
        public double YearsAgo => As(DurationUnit.YearsAgo);
        ...
        internal static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Duration>(DurationUnit.GigayearsAgo, DurationUnit.Second, quantity => quantity.ToUnit(DurationUnit.Second));
            ...
            unitConverter.SetConversionFunction<Duration>(DurationUnit.KiloyearsAgo, DurationUnit.Second, quantity => quantity.ToUnit(DurationUnit.Second));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.MegayearsAgo, DurationUnit.Second, quantity => quantity.ToUnit(DurationUnit.Second));
            ...
            unitConverter.SetConversionFunction<Duration>(DurationUnit.YearsAgo, DurationUnit.Second, quantity => quantity.ToUnit(DurationUnit.Second));
            ...
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Second, DurationUnit.GigayearsAgo, quantity => quantity.ToUnit(DurationUnit.GigayearsAgo));
            ...
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Second, DurationUnit.KiloyearsAgo, quantity => quantity.ToUnit(DurationUnit.KiloyearsAgo));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Second, DurationUnit.MegayearsAgo, quantity => quantity.ToUnit(DurationUnit.MegayearsAgo));
            ...
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Second, DurationUnit.YearsAgo, quantity => quantity.ToUnit(DurationUnit.YearsAgo));
        }
        ...
        /// <summary>
        ///     Creates a <see cref="Duration"/> from <see cref="DurationUnit.GigayearsAgo"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromGigayearsAgo(QuantityValue gigayearsago)
        {
            double value = (double) gigayearsago;
            return new Duration(value, DurationUnit.GigayearsAgo);
        }
        ...
        /// <summary>
        ///     Creates a <see cref="Duration"/> from <see cref="DurationUnit.KiloyearsAgo"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromKiloyearsAgo(QuantityValue kiloyearsago)
        {
            double value = (double) kiloyearsago;
            return new Duration(value, DurationUnit.KiloyearsAgo);
        }

        /// <summary>
        ///     Creates a <see cref="Duration"/> from <see cref="DurationUnit.MegayearsAgo"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromMegayearsAgo(QuantityValue megayearsago)
        {
            double value = (double) megayearsago;
            return new Duration(value, DurationUnit.MegayearsAgo);
        }
        ...
        /// <summary>
        ///     Creates a <see cref="Duration"/> from <see cref="DurationUnit.YearsAgo"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Duration FromYearsAgo(QuantityValue yearsago)
        {
            double value = (double) yearsago;
            return new Duration(value, DurationUnit.YearsAgo);
        }
        ...
        private bool TryToUnit(DurationUnit unit, [NotNullWhen(true)] out Duration? converted)
        {
            ...
            Duration? convertedOrNull = (Unit, unit) switch
            {
                ...
                (DurationUnit.GigayearsAgo, DurationUnit.Second) => new Duration((_value * 365 * 24 * 3600) * 1e9d, DurationUnit.Second),
                ...
                (DurationUnit.KiloyearsAgo, DurationUnit.Second) => new Duration((_value * 365 * 24 * 3600) * 1e3d, DurationUnit.Second),
                (DurationUnit.MegayearsAgo, DurationUnit.Second) => new Duration((_value * 365 * 24 * 3600) * 1e6d, DurationUnit.Second),
                ...
                (DurationUnit.YearsAgo, DurationUnit.Second) => new Duration(_value * 365 * 24 * 3600, DurationUnit.Second),

                // BaseUnit -> DurationUnit
                (DurationUnit.Second, DurationUnit.Day) => new Duration(_value / (24 * 3600), DurationUnit.Day),
                (DurationUnit.Second, DurationUnit.GigayearsAgo) => new Duration((_value / (365 * 24 * 3600)) / 1e9d, DurationUnit.GigayearsAgo),
                ...
                (DurationUnit.Second, DurationUnit.KiloyearsAgo) => new Duration((_value / (365 * 24 * 3600)) / 1e3d, DurationUnit.KiloyearsAgo),
                (DurationUnit.Second, DurationUnit.MegayearsAgo) => new Duration((_value / (365 * 24 * 3600)) / 1e6d, DurationUnit.MegayearsAgo),
                ...
                (DurationUnit.Second, DurationUnit.YearsAgo) => new Duration(_value / (365 * 24 * 3600), DurationUnit.YearsAgo),
