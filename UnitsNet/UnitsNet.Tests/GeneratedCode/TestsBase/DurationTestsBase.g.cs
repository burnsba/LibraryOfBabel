...
// ReSharper disable once PartialTypeWithSinglePart
    public abstract partial class DurationTestsBase : QuantityTestsBase
    {
        ...
        protected abstract double GigayearsAgoInOneSecond { get; }
        protected abstract double HoursInOneSecond { get; }
        protected abstract double JulianYearsInOneSecond { get; }
        protected abstract double KiloyearsAgoInOneSecond { get; }
        protected abstract double MegayearsAgoInOneSecond { get; }
        ...
        protected abstract double YearsAgoInOneSecond { get; }

// ReSharper disable VirtualMemberNeverOverriden.Global
        protected virtual double DaysTolerance { get { return 1e-5; } }
        protected virtual double GigayearsAgoTolerance { get { return 1e-5; } }
        protected virtual double HoursTolerance { get { return 1e-5; } }
        protected virtual double JulianYearsTolerance { get { return 1e-5; } }
        protected virtual double KiloyearsAgoTolerance { get { return 1e-5; } }
        protected virtual double MegayearsAgoTolerance { get { return 1e-5; } }
        ...
        protected virtual double YearsAgoTolerance { get { return 1e-5; } }
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        protected (double UnitsInBaseUnit, double Tolerence) GetConversionFactor(DurationUnit unit)
        {
            return unit switch
            {
                ...
                DurationUnit.GigayearsAgo => (GigayearsAgoInOneSecond, GigayearsAgoTolerance),
                DurationUnit.Hour => (HoursInOneSecond, HoursTolerance),
                DurationUnit.JulianYear => (JulianYearsInOneSecond, JulianYearsTolerance),
                DurationUnit.KiloyearsAgo => (KiloyearsAgoInOneSecond, KiloyearsAgoTolerance),
                DurationUnit.MegayearsAgo => (MegayearsAgoInOneSecond, MegayearsAgoTolerance),
                ...
                DurationUnit.YearsAgo => (YearsAgoInOneSecond, YearsAgoTolerance),
        ...
        public static IEnumerable<object[]> UnitTypes = new List<object[]>
        {
            ...
            new object[] { DurationUnit.GigayearsAgo },
            new object[] { DurationUnit.Hour },
            new object[] { DurationUnit.JulianYear },
            new object[] { DurationUnit.KiloyearsAgo },
            new object[] { DurationUnit.MegayearsAgo },
            ...
            new object[] { DurationUnit.YearsAgo },
        };
        ...
        public void SecondToDurationUnits()
        {
            ...
            AssertEx.EqualTolerance(GigayearsAgoInOneSecond, second.GigayearsAgo, GigayearsAgoTolerance);
            ...
            AssertEx.EqualTolerance(KiloyearsAgoInOneSecond, second.KiloyearsAgo, KiloyearsAgoTolerance);
            AssertEx.EqualTolerance(MegayearsAgoInOneSecond, second.MegayearsAgo, MegayearsAgoTolerance);
            ...
            AssertEx.EqualTolerance(YearsAgoInOneSecond, second.YearsAgo, YearsAgoTolerance);
        }
        ...
        public void From_ValueAndUnit_ReturnsQuantityWithSameValueAndUnit()
        {
            ...
            var quantity01 = Duration.From(1, DurationUnit.GigayearsAgo);
            AssertEx.EqualTolerance(1, quantity01.GigayearsAgo, GigayearsAgoTolerance);
            Assert.Equal(DurationUnit.GigayearsAgo, quantity01.Unit);

            var quantity02 = Duration.From(1, DurationUnit.Hour);
            AssertEx.EqualTolerance(1, quantity02.Hours, HoursTolerance);
            Assert.Equal(DurationUnit.Hour, quantity02.Unit);

            var quantity03 = Duration.From(1, DurationUnit.JulianYear);
            AssertEx.EqualTolerance(1, quantity03.JulianYears, JulianYearsTolerance);
            Assert.Equal(DurationUnit.JulianYear, quantity03.Unit);

            var quantity04 = Duration.From(1, DurationUnit.KiloyearsAgo);
            AssertEx.EqualTolerance(1, quantity04.KiloyearsAgo, KiloyearsAgoTolerance);
            Assert.Equal(DurationUnit.KiloyearsAgo, quantity04.Unit);

            var quantity05 = Duration.From(1, DurationUnit.MegayearsAgo);
            AssertEx.EqualTolerance(1, quantity05.MegayearsAgo, MegayearsAgoTolerance);
            Assert.Equal(DurationUnit.MegayearsAgo, quantity05.Unit);

            var quantity06 = Duration.From(1, DurationUnit.Microsecond);
            AssertEx.EqualTolerance(1, quantity06.Microseconds, MicrosecondsTolerance);
            Assert.Equal(DurationUnit.Microsecond, quantity06.Unit);

            var quantity07 = Duration.From(1, DurationUnit.Millisecond);
            AssertEx.EqualTolerance(1, quantity07.Milliseconds, MillisecondsTolerance);
            Assert.Equal(DurationUnit.Millisecond, quantity07.Unit);

            var quantity08 = Duration.From(1, DurationUnit.Minute);
            AssertEx.EqualTolerance(1, quantity08.Minutes, MinutesTolerance);
            Assert.Equal(DurationUnit.Minute, quantity08.Unit);

            var quantity09 = Duration.From(1, DurationUnit.Month30);
            AssertEx.EqualTolerance(1, quantity09.Months30, Months30Tolerance);
            Assert.Equal(DurationUnit.Month30, quantity09.Unit);

            var quantity10 = Duration.From(1, DurationUnit.Nanosecond);
            AssertEx.EqualTolerance(1, quantity10.Nanoseconds, NanosecondsTolerance);
            Assert.Equal(DurationUnit.Nanosecond, quantity10.Unit);

            var quantity11 = Duration.From(1, DurationUnit.Second);
            AssertEx.EqualTolerance(1, quantity11.Seconds, SecondsTolerance);
            Assert.Equal(DurationUnit.Second, quantity11.Unit);

            var quantity12 = Duration.From(1, DurationUnit.Sol);
            AssertEx.EqualTolerance(1, quantity12.Sols, SolsTolerance);
            Assert.Equal(DurationUnit.Sol, quantity12.Unit);

            var quantity13 = Duration.From(1, DurationUnit.Week);
            AssertEx.EqualTolerance(1, quantity13.Weeks, WeeksTolerance);
            Assert.Equal(DurationUnit.Week, quantity13.Unit);

            var quantity14 = Duration.From(1, DurationUnit.Year365);
            AssertEx.EqualTolerance(1, quantity14.Years365, Years365Tolerance);
            Assert.Equal(DurationUnit.Year365, quantity14.Unit);

            var quantity15 = Duration.From(1, DurationUnit.YearsAgo);
            AssertEx.EqualTolerance(1, quantity15.YearsAgo, YearsAgoTolerance);
            Assert.Equal(DurationUnit.YearsAgo, quantity15.Unit);
        ...
        public void As()
        {
            ...
            AssertEx.EqualTolerance(GigayearsAgoInOneSecond, second.As(DurationUnit.GigayearsAgo), GigayearsAgoTolerance);
            ...
            AssertEx.EqualTolerance(KiloyearsAgoInOneSecond, second.As(DurationUnit.KiloyearsAgo), KiloyearsAgoTolerance);
            AssertEx.EqualTolerance(MegayearsAgoInOneSecond, second.As(DurationUnit.MegayearsAgo), MegayearsAgoTolerance);
            ...
            AssertEx.EqualTolerance(YearsAgoInOneSecond, second.As(DurationUnit.YearsAgo), YearsAgoTolerance);
        }
        ...
        public void Parse()
        {
            ...
            try
            {
                var parsed = Duration.Parse("1 Gya", CultureInfo.GetCultureInfo("en-US"));
                AssertEx.EqualTolerance(1, parsed.GigayearsAgo, GigayearsAgoTolerance);
                Assert.Equal(DurationUnit.GigayearsAgo, parsed.Unit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }
            ...
            try
            {
                var parsed = Duration.Parse("1 kya", CultureInfo.GetCultureInfo("en-US"));
                AssertEx.EqualTolerance(1, parsed.KiloyearsAgo, KiloyearsAgoTolerance);
                Assert.Equal(DurationUnit.KiloyearsAgo, parsed.Unit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }

            try
            {
                var parsed = Duration.Parse("1 Mya", CultureInfo.GetCultureInfo("en-US"));
                AssertEx.EqualTolerance(1, parsed.MegayearsAgo, MegayearsAgoTolerance);
                Assert.Equal(DurationUnit.MegayearsAgo, parsed.Unit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }
            ...
            try
            {
                var parsed = Duration.Parse("1 ya", CultureInfo.GetCultureInfo("en-US"));
                AssertEx.EqualTolerance(1, parsed.YearsAgo, YearsAgoTolerance);
                Assert.Equal(DurationUnit.YearsAgo, parsed.Unit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }
        ...
        public void TryParse()
        {
            ...
            {
                Assert.True(Duration.TryParse("1 Gya", CultureInfo.GetCultureInfo("en-US"), out var parsed));
                AssertEx.EqualTolerance(1, parsed.GigayearsAgo, GigayearsAgoTolerance);
                Assert.Equal(DurationUnit.GigayearsAgo, parsed.Unit);
            }
            ...
            {
                Assert.True(Duration.TryParse("1 kya", CultureInfo.GetCultureInfo("en-US"), out var parsed));
                AssertEx.EqualTolerance(1, parsed.KiloyearsAgo, KiloyearsAgoTolerance);
                Assert.Equal(DurationUnit.KiloyearsAgo, parsed.Unit);
            }

            {
                Assert.True(Duration.TryParse("1 Mya", CultureInfo.GetCultureInfo("en-US"), out var parsed));
                AssertEx.EqualTolerance(1, parsed.MegayearsAgo, MegayearsAgoTolerance);
                Assert.Equal(DurationUnit.MegayearsAgo, parsed.Unit);
            }
            ...
            {
                Assert.True(Duration.TryParse("1 ya", CultureInfo.GetCultureInfo("en-US"), out var parsed));
                AssertEx.EqualTolerance(1, parsed.YearsAgo, YearsAgoTolerance);
                Assert.Equal(DurationUnit.YearsAgo, parsed.Unit);
            }
        ...
        public void ParseUnit()
        {
            ...
            try
            {
                var parsedUnit = Duration.ParseUnit("Gya", CultureInfo.GetCultureInfo("en-US"));
                Assert.Equal(DurationUnit.GigayearsAgo, parsedUnit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }
            ...
            try
            {
                var parsedUnit = Duration.ParseUnit("kya", CultureInfo.GetCultureInfo("en-US"));
                Assert.Equal(DurationUnit.KiloyearsAgo, parsedUnit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }

            try
            {
                var parsedUnit = Duration.ParseUnit("Mya", CultureInfo.GetCultureInfo("en-US"));
                Assert.Equal(DurationUnit.MegayearsAgo, parsedUnit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }
            ...
            try
            {
                var parsedUnit = Duration.ParseUnit("ya", CultureInfo.GetCultureInfo("en-US"));
                Assert.Equal(DurationUnit.YearsAgo, parsedUnit);
            } catch (AmbiguousUnitParseException) { /* Some units have the same abbreviations */ }
        ...
        public void TryParseUnit()
        {
            ...
            {
                Assert.True(Duration.TryParseUnit("Gya", CultureInfo.GetCultureInfo("en-US"), out var parsedUnit));
                Assert.Equal(DurationUnit.GigayearsAgo, parsedUnit);
            }
            ...
            {
                Assert.True(Duration.TryParseUnit("kya", CultureInfo.GetCultureInfo("en-US"), out var parsedUnit));
                Assert.Equal(DurationUnit.KiloyearsAgo, parsedUnit);
            }

            {
                Assert.True(Duration.TryParseUnit("Mya", CultureInfo.GetCultureInfo("en-US"), out var parsedUnit));
                Assert.Equal(DurationUnit.MegayearsAgo, parsedUnit);
            }
            ...
            {
                Assert.True(Duration.TryParseUnit("ya", CultureInfo.GetCultureInfo("en-US"), out var parsedUnit));
                Assert.Equal(DurationUnit.YearsAgo, parsedUnit);
            }
        ...
        public void ConversionRoundTrip()
        {
            ...
            AssertEx.EqualTolerance(1, Duration.FromGigayearsAgo(second.GigayearsAgo).Seconds, GigayearsAgoTolerance);
            ...
            AssertEx.EqualTolerance(1, Duration.FromKiloyearsAgo(second.KiloyearsAgo).Seconds, KiloyearsAgoTolerance);
            AssertEx.EqualTolerance(1, Duration.FromMegayearsAgo(second.MegayearsAgo).Seconds, MegayearsAgoTolerance);
            ...
            AssertEx.EqualTolerance(1, Duration.FromYearsAgo(second.YearsAgo).Seconds, YearsAgoTolerance);
        }
        ...
        public void ToString_ReturnsValueAndUnitAbbreviationInCurrentCulture()
        {
            ...
            try {
                ...
                Assert.Equal("1 Gya", new Duration(1, DurationUnit.GigayearsAgo).ToString());
                ...
                Assert.Equal("1 kya", new Duration(1, DurationUnit.KiloyearsAgo).ToString());
                Assert.Equal("1 Mya", new Duration(1, DurationUnit.MegayearsAgo).ToString());
                ...
                Assert.Equal("1 ya", new Duration(1, DurationUnit.YearsAgo).ToString());
            }
            finally
            {
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 Gya", new Duration(1, DurationUnit.GigayearsAgo).ToString(swedishCulture));
            ...
            Assert.Equal("1 kya", new Duration(1, DurationUnit.KiloyearsAgo).ToString(swedishCulture));
            Assert.Equal("1 Mya", new Duration(1, DurationUnit.MegayearsAgo).ToString(swedishCulture));
            ...
            Assert.Equal("1 ya", new Duration(1, DurationUnit.YearsAgo).ToString(swedishCulture));
        }
